...
export const AbsoluteImagesComponent = () => {
	...
	return (
		<div className="overflow-hidden">
			<div style={{ zIndex: 100 }} className="flex justify-center items-center z-100 w-full overflow-hidden">
				<div
					style={{ zIndex: 120 }}
					className={`bg-[#404833] ${
				...
				>
					<a
						onClick={() => router.push("/")}
						className={`text-[20px] font-bold p-0 flex items-center text-center justify-center transition duration-500 hover:text-[#B0CD80] md:text-[1.5rem] desktop:text-[2.5rem] cursor-pointer ${
							router.pathname === "/" ? "text-[#FCFC03] hover:text-[#FCFC03]" : "text-white"
						}`}
					>
						HOME
					</a>
					<a
						...
						className={`text-[20px] font-bold p-0 flex items-center text-center justify-center transition duration-500 hover:text-[#B0CD80] md:text-[1.5rem] desktop:text-[2.5rem] cursor-pointer ${
							router.pathname === "/airdrop" ? "text-[#FCFC03] hover:text-[#FCFC03]" : "text-white"
						}`}
					>
						AIRDROP
					</a>
					<a
						...
						className={`text-[20px] font-bold p-0 text-center flex items-center justify-center transition duration-500 hover:text-[#B0CD80] md:text-[1.5rem] desktop:text-[2.5rem] cursor-pointer ${
							router.pathname === "/referral" ? "text-[#FCFC03] hover:text-[#FCFC03]" : "text-white"
						}`}
					>
						REFERRAL
					</a>
			...
			<Image
				...
				width={maxWidth < 500 ? 100 : maxWidth > 1500 ? 200 : maxWidth > 2000 ? 300 : 150}
				height={122}
				alt="cloud"
			/>
			<Image
			...
			/>
			<Image
				className="absolute bottom-[5%] md:bottom-[12%] w-[30%] z-50 md:w-[10%] left-[-15%] md:left-[-2%]"
			...
			/>
			<Image
				className="absolute bottom-[5%] w-[30%] md:bottom-[12%] md:w-[10%] z-50 right-[-15%] md:right-[-2%]"
			...
			>
				...
				<a href="https://flappy-blast.gitbook.io/flappyblast-docs" target="_blank">
