    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        >
          <a
            onClick={() => router.push("/")}
            className={`text-[1rem] font-bold p-0 flex items-center text-center justify-center transition duration-500 hover:text-[#B0CD80] md:text-[2rem] desktop:text-[2.5rem] large-desktop:text-[3.5rem] cursor-pointer ${
              router.pathname === "/"
          ...
          <a
            ...
            className={`text-[1rem] font-bold p-0 text-center flex items-center justify-center transition duration-500 hover:text-[#B0CD80] md:text-[2rem] desktop:text-[2.5rem] large-desktop:text-[3.5rem] cursor-pointer ${
