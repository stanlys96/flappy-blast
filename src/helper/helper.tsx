export const CarouselData = [
	{
		...
		textHovered: "The price can only go up, starting at the initial sale price.",
		isHovered: false,
	},
	{
		id: 2,
		...
		textHovered: "All ETH raised goes to the liquidity pool—no tokens are held by the devs.",
		isHovered: false,
	},
	{
		id: 3,
		...
		textHovered: "Trading fees and native yield keep boosting the floor price.",
		isHovered: false,
	},
	{
		id: 4,
