...
export default function AirdropPage() {
  ...
  const handlePartnershipButton = () => {
    ...
    if (partnershipResult) {
      ...
      if (
        allocationsResult &&
        allocationsResult?.totalAllocations >= allocationsResult?.maxAllocations
      ) {
      ...
      >
          ...
          {currentState === "airdropends" && (
            <div className="flex gap-x-[10px] h-[20vh] items-center">
              <p className="font-bold text-black md:text-[16px] text-[12px] text-center">
                Airdrop has ended. Snapshot will be released soon.
                <br></br>
              </p>
              ...
              <div className="flex flex-col items-center md:items-start gap-y-[20px]">
                ...
                <div className="flex gap-x-[10px] items-center">
                  <p className="font-bold text-black md:text-[16px] text-[12px]">
                    1.{" "}
                    <span>
                      login via twitter and complete the one time verification
                      of wallet and
                    </span>
                    <br></br>
                    <span>
                ...
                <div className="flex gap-x-[10px] items-center">
                  <p className="font-bold md:text-left text-center md:text-[16px] text-[12px]">
                    2. claim free $FLAP for extra allocation only for partnered
                    projects
                  </p>
                </div>
              ...
              <div className="flex md:flex-row flex-col gap-x-[40px] justify-center items-center">
                ...
                >
                  <Image
                    ...
                    alt="button"
                    src={`/images/${
                      session ? "flap_button.png" : "Flap_Disabled.png"
                    }`}
                  />
                </div>
                <div
                  ...
                  <>
                    ...
                    >
                      <div className="flex flex-col gap-2">
                        <div className="text-center flex flex-col gap-6 mb-6">
                          <div>
                            <p>
                              To become eligible, please complete the one-time
                              tasks.
                            </p>
                            <p>
                              After that, you can play FlappyBlast and easily
                          ...
                          <div className="flex flex-col justify-center items-center w-full gap-2">
                            ...
                            {!isBlast && (
                              <p className="text-red-500">
                                *Please switch your network to Blast and try
                                again.
                              </p>
                            )}
                          </div>
                        ...
                        <div className="text-center bg-[#F0F0F0] p-4 font-bold mx-6 mt-4">
                          NOTICE: This action can only be done once, you will
                          not able to change your wallet address connected with
                          you X account with us
                        </div>
                        <div className="flex justify-center w-full">
                          {confirmLoading ? (
                        ...
                        <div className="flex justify-between">
                          ...
                          >
                            <div className="flex items-center gap-x-2">
                              <span>5. </span>
                              <span className="underline">
                                Join Flappy Blast&apos;s Discord Server
                              </span>
                          ...
                          {verificationStatus.discord === "unopened" ? (
                            <a
                              target="_blank"
                              href="https://discord.gg/qNcNxfVmVA"
                            >
                            ...
                            <Button
                              type="primary"
                              onClick={() => handleVerification("discord")}
                              style={getSocialActionButtonStyles("discord")}
                              icon={
                                verificationStatus.discord === "unverified" ? (
                                  <CaretRightOutlined
                                    style={{
                                      color: "#000",
                                    }}
                              ...
                              iconPosition={"end"}
                            >
                              {verificationStatus.discord === "verifying"
                                ? "Verifying..."
                        ...
                        <div className="flex justify-between">
                          ...
                          >
                            <div className="flex items-center gap-x-2">
                              <span>6. </span>
                              <span className="underline">
                                Join Flappy Blast&apos;s Telegram Channel
                              </span>{" "}
                              <span className="text-red-500">
                                *not required
                              </span>
                          ...
                          {verificationStatus.telegram === "unopened" ? (
                            <a
                              target="_blank"
                              href="https://t.me/+esBMo_0AwCcwZWZl"
                            >
                            ...
                            <Button
                              ...
                              style={getSocialActionButtonStyles("telegram")}
                              icon={
                                verificationStatus.telegram === "unverified" ? (
                                  <CaretRightOutlined
                                    style={{
                                      color: "#000",
                                    }}
                              ...
                              iconPosition={"end"}
                            >
                              {verificationStatus.telegram === "verifying"
                                ? "Verifying..."
                    ...
                    >
                      <div className="text-center my-6">
                        <p>
                          Congrats! Just play Flappyblast and share your scores
                          with us! Join our fun Discord community to share and
                          compare. &nbsp;
                          <a
                            href="https://discord.gg/qNcNxfVmVA"
                            target="_blank"
          ...
          {currentState === "leaderboard" && (
            <>
              ...
              <Pagination
                ...
                defaultCurrent={1}
                total={leaderboardsResult?.meta?.pagination?.total ?? 0}
                pageSize={leaderboardsResult?.meta?.pagination?.pageSize ?? 0}
                onChange={(page) => {
                  setCurrentPage(page);
                  if (tableRef) {
        ...
        >
          <div className="flex flex-col gap-2">
            <div className="text-center flex flex-col gap-6">
              <div>
                <p>
                  Select the project you belong to, but remember, you can only
                  link with one project. Ensure you&apos;ve met all the
                  requirements to successfully claim your rewards.
                </p>
              </div>
            </div>
            {!address ? (
            ...
            {dropdownValue !== "Choose Project" && (
              <div className="flex gap-x-[10px] items-center justify-center roboto">
                ...
                <div
                  className={`${
                    isEligible ? "bg-[#4FB768]" : "bg-[#B74F4F]"
                  } rounded-[3px] p-[8px]`}
                >
            ...
            <p className="font-bold text-center">
              ...
              {allocationsResult?.maxAllocations?.toLocaleString("en-US")}{" "}
              Claimed
            </p>
        ...
        >
          <div className="flex flex-col gap-2">
            <div className="text-center flex flex-col gap-6">
              <p>
                Congratulations! Your wallet is now successfully connected to
                the{" "}
                {partnershipResult?.attributes?.partner_list?.data?.attributes
                  ?.project_name ??
                  currentSelectedProject?.attributes?.project_name}{" "}
                project. Just a heads up, you can only claim the extra
                allocation once !
              </p>
            </div>
            <a
            ...
            <div className="text-center flex flex-col gap-6">
              <p>
                ...
                {partnershipResult?.attributes?.partner_list?.data?.attributes
                  ?.project_name ??
                  currentSelectedProject?.attributes?.project_name}{" "}
                project. Remember, you can only connect with one project at a
                time.
              </p>
            </div>
            <a
