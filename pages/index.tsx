...
export default function HomePage() {
  ...
  const [pageState, setPageState] = useState<"index" | "presale">("index");
  ...
  const onRefferalChange = (e: RadioChangeEvent) => {
    if (e.target.value === "flappyblast") {
      ...
      setCurrentReferralUrl("https://app.bladeswap.xyz/meme-world/flap?mref=");
    }
  ...
  const handleMouseEnter2 = () => {
    setText2(
      <div className="text-[16px]">
        All ETH raised goes to the liquidity pool—no tokens are held by the
        devs.
      </div>
    );
    setIsHovered2(true);
            ...
            >
              ...
              <div className="flex gap-4 w-fit flex-col md:flex-row text-lg">
                ...
                <div className="p-2 mx-8 bg-white w-fit mx-auto border-4 border-black font-bold text-center">
                  Total Raised:{" "}
                  {totalCommitmentsResult?.toString()?.slice(0, 7)} ETH / 150
                  ETH
                </div>
              </div>
                      ...
                      <div>
                        <div className="bg-white  border-4 border-black flex justify-between py-1 pl-4 pr-1 items-center">
                          ...
                          <Button
                            ...
                            onClick={async () => {
                              setFlapAmount(
                                data?.formatted?.toString()?.slice(0, 7) ?? "0"
                              );
                            }}
                          >
                            MAX
                      ...
                      <div className="flex justify-center items-center md:items-start">
                        {isPending || waitingForReceipt ? (
                          <div className="w-[150px] justify-center items-center">
                            <Spin className="w-[150px]" size={"large"} />
                          </div>
                        ) : (
                          <div
                            onClick={async () => {
                              ...
                              if (
                                parseFloat(flapAmount ?? "0") +
                                  parseFloat(
                                    userCommitmentsResult?.toString() ?? "0"
                                  ) >
                                3
                              ) {
                                return Swal.fire({
                              ...
                              try {
                                const result = await writeContractAsync({
                                  ...
                                  functionName: "commit",
                                  args: [referralCode],
                                  value: parseEther(flapAmount),
                                });
                                setTransactionHash(result);
                                setWaitingForReceipt(true);
                              } catch (e: any) {
                                console.log(e?.toString(), "<< WALO");
                              }
                            }}
                            className={`${
                              disableBtn || waitingForReceipt
                                ? "cursor-not-allowed"
                                : "cursor-pointer"
                            }`}
                          >
                    ...
                    <div className="bg-white border-4 border-black flex flex-wrap md:flex-nowrap justify-between py-2 pl-4 pr-2 items-center gap-x-2">
                      <div className="flex mb-2 md:mb-0">
                        <p className="text-ellipsis text-[9px] md:text-[10px] md:text-left text-center">
                          {currentReferralUrl}
                          {currentTwitterData?.attributes?.referral_code}
                        </p>
                      </div>
                ...
                <div className="bg-[#ddd894] p-4 rounded-lg">
                  ...
                  <div className="px-6 py-2 mb-4 bg-[#FEF9C0] text-md">
                    ...
                    <p className="text-md font-bold">
                      {userCommitmentsResult?.toString()?.slice(0, 7)} ETH
                    </p>
                  </div>
                  <div className="my-2">
                  ...
                  <div className="my-2">
                    ...
                    <p className="text-md font-bold">June 23 2024,13:00 UTC</p>
                  </div>
                  ...
                  >
                    <p
                      className={`text-center font-bold ${
                        data?.textHovered
                          ?.toLowerCase()
                          ?.includes("all eth raised goes to") && "text-[18px]"
                      }`}
                    >
      ...
      <div className="h-[140vh] md:h-[120vh] desktop:h-[120vh] large-desktop:h-[115vh] flex flex-col justify-center items-center px-[150px] bg-black">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="text-[#FCFC03] text-[0.8rem] md:text-[1.5rem] desktop:text-[2.5rem] large-desktop:text-[3.5rem] text-center mb-[30px]">
            100,000,000{" "}
            <span className="font-light">(100% UNRUGGABLE, 0% DEV)</span>
          </p>
