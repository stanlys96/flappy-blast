			...
			<HeroLayout>
				<div className="flex flex-col h-[100vh] md:h-[95vh] desktop:h-[100vh] large-desktop:h-[80vh] justify-center items-center">
					...
					<div className="block md:hidden flex items-center">
						<Image width={400} height={70} alt="flappy-blast" src="/images/flappy-blast.png" />
					</div>
					<div
						onClick={() => router.push("/airdrop")}
						className="md:block hidden relative mt-[25px] cursor-pointer"
					>
						<Image width={300} height={100} alt="button" src="/images/button.png" />
					</div>
					<div
						onClick={() => router.push("/airdrop")}
						className="block md:hidden relative mt-[25px] cursor-pointer"
					>
						<Image width={150} height={100} alt="button" src="/images/button.png" />
					</div>
					<div
						className="bg-[#FFFFFF] flex justify-center items-center mt-[30px] px-[20px] py-[12px]"
						style={{ zIndex: "100" }}
					>
						<p className="text-black md:text-[16px] text-[12px] large-desktop:text-[2rem]">
							airdrop campaign ends in: {timeLeft?.hours?.toString().padStart(2, "0")}:
