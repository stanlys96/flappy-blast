...
export default function HomePage() {
	...
	const handleMouseEnter2 = () => {
		setText2(<div>All ETH raised goes to the liquidity pool—no tokens are held by the devs.</div>);
		setIsHovered2(true);
	};
		...
		<div className="w-full overflow-hidden">
			<HeroLayout>
				<div>
					<div className="pt-[20vh] md:pt-0 flex w-full h-[100vh] justify-center items-start md:items-center">
						<div className="flex flex-col items-center gap-8" style={{ zIndex: 110, position: relative }}>
							<PresaleTitle />
							<div className="flex gap-4 justify-center items-stretch">
								<Image width={250} height={35} alt="blade" src="/images/blade.png" />
							...
							<div className="flex gap-4 flex-col md:flex-row">
								<div className="bg-[#ddd894] p-4">
									...
									<div className="my-2">
										...
										<div className="flex justify-between gap-4 flex-col md:flex-row">
											<div>
												...
												<p className="text-sm">Balance: 0.00 ETH</p>
											</div>
											{/* button enabled */}
											<div>
												<Image
									...
									<div className="flex justify-between mt-4">
										<div className="text-xl font-bold">Refferal</div>
										<div>
											<Button
												style={{
													border: "2px solid",
									...
									<div className="my-2">
										<div className="text-sm mb-2">
											<Radio.Group onChange={onRefferalChange} value={refferalRadioValue}>
												<Radio value={"flappyblast"}>Flappyblast site</Radio>
												<Radio value={"bladeswap"}>Bladeswap site</Radio>
											</Radio.Group>
										</div>
										<div className="bg-white border-4 border-black flex justify-between py-1 pl-4 pr-1 items-center">
											<input aria-label="flap-amount" placeholder="0.00" type="text"></input>
											<div>
												<Button
													type="primary"
													style={{
								...
								<div className="bg-[#ddd894] p-4">
									<div className="text-xl font-bold mb-4">Sale Info</div>
									...
									<div className="my-2">
										...
										<p className="font-semibold">June 21 2024,00:00 UTC</p>
									</div>
									<div className="my-2">
										<p className="text-sm">End of Sale</p>
										<p className="font-semibold">June 23 2024,00:00 UTC</p>
									</div>
									<div className="flex gap-6 my-2">
										<div>
											<p className="text-sm whitespace-nowrap">Sale Type</p>
											<p className="font-semibold whitespace-nowrap">Fairlaunch</p>
										</div>
										<div>
											<p className="text-sm whitespace-nowrap">Method</p>
											<p className="font-semibold whitespace-nowrap">Overflow</p>
										</div>
										<div>
											<p className="text-sm whitespace-nowrap">Claim Token</p>
											<p className="font-semibold whitespace-nowrap">via Bladeswap</p>
										</div>
									</div>
									<div>
          ...
          <div className="block md:hidden relative mt-[25px] cursor-pointer">
			...
			<div className="flex md:flex-row gap-y-[40px] flex-col py-[25px] justify-center items-center h-[140vh] desktop:h-[100vh] large-desktop:h-[100vh] bg-black md:pt-[50px] md:pt-0">
				<div className="flex md:flex-1 md:pl-[150px] justify-center items-center md:items-start flex-col gap-y-[20px] desktop:gap-y-[40px] large-desktop:pl-[250px]">
					...
					<p className="inter md:text-left text-center md:px-0 px-[20px] text-[14px] md:text-[18px] desktop:text-[1.5rem] large-desktop:text-[2rem] font-normal text-white">
						The protocol keeps all its tokens on the blockchain to always protect their value. This creates
						a baseline value that never goes down. Over time, protocol fees are used to boost this baseline
						value, making it{" "}
			...
			<div className="md:hidden block h-full bg-[#262626] relative w-full pt-[50px] md:pt-0">
				<Carousel className="h-full w-full flex justify-center items-center mx-auto" arrows>
					{totalCarouselData.map((data) => (
						<div key={data.id} className="flex h-full w-full flex-col items-center justify-end relative">
							<div
								onClick={() => {
									...
									if (currentCarouselData) {
										currentCarouselData.isHovered = !currentCarouselData?.isHovered;
			...
			<div className="h-[140vh] md:h-[120vh] desktop:h-[120vh] large-desktop:h-[90vh] flex flex-col justify-center items-center px-[150px] bg-black">
				<div className="flex flex-col justify-center items-center">
					...
					<p className="text-[#FCFC03] text-[0.8rem] md:text-[1.5rem] desktop:text-[2.5rem] large-desktop:text-[3.5rem] text-center mb-[30px]">
						100,000,000 <span className="font-light">(100% UNRUGGABLE, 0% DEV)</span>
					</p>
