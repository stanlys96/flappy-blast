...
export default function PresalePage() {
	...
	return (
		<HeroLayout>
			<div className="pt-[13vh] md:pt-0 flex w-full h-[100vh] justify-center items-start md:items-center">
				<div
					...
					<div className="flex gap-4 flex-col md:flex-row w-[80vw] md:w-fit">
						<div className="bg-[#ddd894] p-4 rounded-lg">
							<div className="flex justify-between mb-4">
								<div className="text-xl font-bold kong-text">Sale</div>
								<div>
									<Button
										style={{
											border: "2px solid",
							...
							<div className="flex justify-between mt-4">
								<div className="text-xl font-bold kong-text">Refferal</div>
								<div>
									<Button
										style={{
											border: "2px solid",
						...
						<div className="bg-[#ddd894] p-4 rounded-lg">
							<div className="text-xl font-bold mb-4 kong-text">Sale Info</div>
