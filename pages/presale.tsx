						...
						<div className="flex gap-4 flex-col md:flex-row w-[80vw] md:w-fit">
							<div className="bg-[#ddd894] p-4 rounded-lg">
								<div className="flex justify-between mb-4">
									<div className="text-xl md:text-2xl font-bold kong-text">Sale</div>
									<div>
										<Button
											style={{
												border: "2px solid",
								...
								<div className="my-2">
									...
									<div className="flex justify-between gap-4 flex-col md:flex-row">
										<div>
											...
											<p className="text-md">Balance: 0.00 ETH</p>
										</div>
										{/* button enabled */}
										<div>
											<Image
								...
								<div className="flex justify-between mt-4">
									<div className="text-xl md:text-2xl font-bold kong-text">Refferal</div>
									<div>
										<Button
											style={{
												border: "2px solid",
							...
							<div className="bg-[#ddd894] p-4 rounded-lg">
								<div className="text-xl md:text-2xl font-bold mb-4 kong-text">Sale Info</div>
								...
								<div className="my-2">
									...
									<p className="text-md font-semibold">June 21 2024,00:00 UTC</p>
								</div>
								<div className="my-2">
									<p className="text-base">End of Sale</p>
									<p className="text-md font-bold">June 23 2024,00:00 UTC</p>
								</div>
								<div className="flex gap-6 my-2">
									<div>
										<p className="text-base whitespace-nowrap">Sale Type</p>
										<p className="text-md font-semibold whitespace-nowrap">Fairlaunch</p>
									</div>
									<div>
										<p className="text-base whitespace-nowrap">Method</p>
										<p className="text-md font-semibold whitespace-nowrap">Overflow</p>
									</div>
									<div>
										<p className="text-base whitespace-nowrap">Claim Token</p>
										<p className="text-md font-semibold whitespace-nowrap">via Bladeswap</p>
									</div>
								</div>
								<div>
									<p className="text-base">Hard Cap</p>
									<p className="text-md font-semibold">150 ETH</p>
								</div>
							</div>
						</div>
					</div>
