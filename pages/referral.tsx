              ...
              <div className="md:flex-row flex-col bg-[#B7CC5B] rounded-[8px] p-[24px] w-full flex gap-x-[20px] items-center">
                ...
                <div className="flex flex-col gap-y-[5px]">
                  ...
                  <p className="md:text-[16px] text-[12px] md:text-left text-center font-bold">
                    Your score:{" "}
                    {currentTwitterData?.attributes?.presale_points ?? "0"}
                  </p>
                  <p className="md:text-[16px] text-[12px] md:text-left text-center">
                    You referred: {referredPeopleResult?.count ?? "0"} friends
                  </p>
                </div>
              </div>
              <div className="flex flex-col gap-y-[20px]">
                <p className="md:text-left text-center font-bold md:text-[16px] text-[12px]">
                  1. referral score will be calculated by the amount of eth your
                  friend has committed for the presale.
                </p>
                <p className="md:text-left text-center font-bold md:text-[16px] text-[12px]">
                  2. referral campaign will end after sale ends. we will
                  distribute rewards after token launch.
                </p>
              </div>
            </div>
          )}
                      ...
                      leaderboardsResult?.data?.map(
                        (sortedLeaderboardData: DataObject, index: number) => (
                          ...
                          >
                            ...
                            <td className="py-4 px-2 whitespace-nowrap text-sm md:text-base">
                              {sortedLeaderboardData?.attributes?.boosted
                                ? sortedLeaderboardData?.attributes
                                    ?.boost_multiplier *
                                  sortedLeaderboardData?.attributes
                                    ?.presale_points
